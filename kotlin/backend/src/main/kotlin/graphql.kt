  ...
  SponsorGroup(
    ...
    sponsors = listOf(
      Sponsor(
        ...
        logoLight = "$SPONSOR_LOGO_BASE/meta-light.png",
  ...
  SponsorGroup(
    ...
    sponsors = listOf(
      Sponsor(
        ...
        logoLight = "$SPONSOR_LOGO_BASE/wg-light.png",
        logoDark = "$SPONSOR_LOGO_BASE/wg-dark.png",
      ),
      Sponsor(
        name = "The Guild",
        url = "https://the-guild.dev/graphql/hive",
        logoLight = "$SPONSOR_LOGO_BASE/tg-light.png",
        logoDark = "$SPONSOR_LOGO_BASE/tg-dark.png",
      ),
    ),
  ),
  SponsorGroup(
  ...
  SponsorGroup(
    ...
    sponsors = listOf(
      Sponsor(
        ...
        logoLight = "$SPONSOR_LOGO_BASE/grafast-light.png",
        logoDark = "$SPONSOR_LOGO_BASE/grafast-dark.png",
      ),
    ),
  ),
)
